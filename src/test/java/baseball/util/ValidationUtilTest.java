...
class ValidationUtilTest {
    ...
    @Test
    void givenUserInputString_whenCallValidateConvertNumberMethod_thenIllegalArgumentException() throws Exception {
        //Given
    ...
    @Test
    void givenUserInputString_whenCallValidateDigitsInRangeMethod_thenIllegalArgumentException() throws Exception {
        //Given
    ...
    @Test
    void givenTwoUserInputLength_whenCallValidateDuplicateMethod_thenIllegalArgumentException() throws Exception {
        //Given
        int userInputStringLength = 3;
        int deduplicatedUserInputLength = 2;
        // When & then
        assertThatThrownBy(() -> validateDuplicate(userInputStringLength,deduplicatedUserInputLength))
                .isInstanceOf(IllegalArgumentException.class);
    }

    @DisplayName("지정된 예약어가 아니면 IllegalArgumentException 발생")
    @Test
    void givenUserInputString_whenCallValidateReservedWordMethod_thenIllegalArgumentException() throws Exception {
        //Given
        String userInput = "3";
        // When & then
